    ...
    return (
        <div className="modal modal-open overflow-x-hidden">
            <div className="modal-box mx-auto">
                ...
                <div className="flex-1 min-h-0 space-y-4 overflow-y-auto overscroll-contain py-4 sm:py-5">
                    <div className="rounded-lg border border-base-300 bg-base-100 p-3 sm:p-4">
                ...
                <div className="flex justify-end border-t border-base-200 pt-3 sm:pt-4">
                    <button
                        type="button"
