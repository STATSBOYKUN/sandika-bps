...
export default function DataIndustriTable({
	...
	return (
		<section className="border-base-300 bg-base-100 overflow-hidden rounded-xl border shadow-sm">
			...
			>
				<table
					className="table-sm table border-separate border-spacing-0"
					style={{
									...
									<th
										...
										className={
											header.column.getCanSort()
												? "relative align-top break-words whitespace-normal select-none"
									...
									>
										...
										{header.column.getCanResize() && (
											<div
												...
												className={`absolute top-0 -right-1 h-full w-3 cursor-col-resize touch-none select-none ${header.column.getIsResizing() ? "bg-primary/40" : "hover:bg-base-content/20"}`}
											/>
										)}
									</th>
								))}
								...
								<tr
									...
									className={
										!row.original.isInsideKaranganyar
											? "bg-error/12 border-error/35 border-l-error hover:bg-error/20 border-y border-l-4"
								...
								>
									{row.getVisibleCells().map((cell) => (
										<td
											...
											className="cursor-pointer align-top break-words whitespace-normal"
										>
											{flexRender(
			...
			<div className="border-base-300 bg-base-200/40 flex flex-col gap-3 border-t px-3 py-3 sm:px-4 md:flex-row md:items-center md:justify-between">
				...
				<div className="flex w-full flex-col gap-2 md:w-auto md:flex-row md:items-center md:justify-between">
					<div className="flex flex-wrap items-center gap-2">
						...
						<div className="join w-full self-end overflow-x-auto sm:w-auto md:self-auto">
							<button
								type="button"
