...
const googleMapsColumns: ColumnDef<IndustryRow>[] = [
	...baseColumns(true),
	{
		...
		cell: (info) => {
			...
			return (
				<span className="font-mono text-xs">{value.toFixed(6)}</span>
			);
		},
	},
	{
	...
	},
	{
		accessorFn: (row) =>
			row.platform === "Google Maps"
				? (row as GoogleMapsIndustryRow).metadata.rating
				: 0,
		id: "rating",
		header: "Rating",
		size: 120,
...
const youtubeColumns: ColumnDef<IndustryRow>[] = [
	...
	},
	{
		accessorFn: (row) =>
			row.platform === "YouTube"
				? (row as YouTubeIndustryRow).metadata.videoTitle
				: "",
		id: "videoTitle",
		header: "Judul Video",
		size: 320,
	...
	},
	{
		accessorFn: (row) =>
			row.platform === "YouTube"
				? (row as YouTubeIndustryRow).metadata.viewCount
				: 0,
		id: "viewCount",
		header: "Views",
		size: 150,
	...
	},
	{
		accessorFn: (row) =>
			row.platform === "YouTube"
				? (row as YouTubeIndustryRow).metadata.likeCount
				: 0,
		id: "likeCount",
		header: "Likes",
		size: 130,
...
const tiktokColumns: ColumnDef<IndustryRow>[] = [
	...
	},
	{
		accessorFn: (row) =>
			row.platform === "TikTok"
				? (row as TikTokIndustryRow).metadata.videoTitle
				: "",
		id: "videoTitle",
		header: "Judul Video",
		size: 320,
	...
	},
	{
		accessorFn: (row) =>
			row.platform === "TikTok"
				? (row as TikTokIndustryRow).metadata.publishedAt
				: "",
		id: "publishedAt",
		header: "Tanggal Publish",
		size: 210,
	...
	},
	{
		accessorFn: (row) =>
			row.platform === "TikTok"
				? (row as TikTokIndustryRow).metadata.viewCount
				: 0,
		id: "viewCount",
		header: "Views",
		size: 150,
	...
	},
	{
		accessorFn: (row) =>
			row.platform === "TikTok"
				? (row as TikTokIndustryRow).metadata.likeCount
				: 0,
		id: "likeCount",
		header: "Likes",
		size: 130,
	...
	},
	{
		accessorFn: (row) =>
			row.platform === "TikTok"
				? (row as TikTokIndustryRow).metadata.commentCount
				: 0,
		id: "commentCount",
		header: "Komentar",
		size: 150,
	...
	},
	{
		accessorFn: (row) =>
			row.platform === "TikTok"
				? (row as TikTokIndustryRow).metadata.shareCount
				: 0,
		id: "shareCount",
		header: "Share",
		size: 140,
	...
	},
	{
		accessorFn: (row) =>
			row.platform === "TikTok"
				? (row as TikTokIndustryRow).metadata.followerCount
				: 0,
		id: "followerCount",
		header: "Follower",
		size: 160,
...
export function getTabConfigByKey(key: DataIndustriTabKey) {
	return (
		DATA_INDUSTRI_TABS.find((tab) => tab.key === key) ??
		DATA_INDUSTRI_TABS[0]
	);
}
