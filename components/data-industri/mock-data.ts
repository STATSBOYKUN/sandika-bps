...
function buildYoutubeRow(base: IndustryBaseRow, index: number): YouTubeIndustryRow {
...
function buildTiktokRow(base: IndustryBaseRow, index: number): TikTokIndustryRow {
