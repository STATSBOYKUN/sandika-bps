		...
		<PageShell width="4xl" className="space-y-6">
				...
				<div className="grid grid-cols-1 gap-4 md:grid-cols-2">
					{guides.map((item) => {
						...
						return (
							<article
								key={item.title}
								className="border-base-300 bg-base-100 rounded-lg border p-5"
							>
			...
			<section className="border-base-300 bg-base-200/50 rounded-xl border p-6">
				...
				<ul className="space-y-3">
					<li className="border-base-300 bg-base-100 flex items-center gap-2 rounded-lg border px-4 py-3 text-sm">
						<CircleCheckBig className="text-success h-4 w-4" />
